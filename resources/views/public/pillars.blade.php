...
@section('content')
    ...
    <section class="py-16 bg-white border-b border-slate-200">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl md:text-2xl text-[#1b1d21] leading-relaxed font-heading font-semibold animate-fade-up">
            ...
            <div id="literacy" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    <div class="lg:col-span-4 flex items-center justify-center">
                        <div class="w-24 h-24 rounded-3xl bg-blue-50 border border-blue-100 flex items-center justify-center text-5xl text-[#43baff]">
                            🎓
                        </div>
                    </div>
                    <div class="lg:col-span-8 space-y-4">
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-[#43baff] font-heading font-extrabold text-xs">
                            PILLAR 01
                        </div>
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">AI Literacy & Awareness</h2>
            ...
            <div id="curriculum" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-8 space-y-4">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">Curriculum Integration</h2>
                        <p class="text-[#5e6278] text-sm sm:text-base leading-relaxed">
            ...
            <div id="training" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-8 space-y-4">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">Teacher & Faculty Training</h2>
                        <p class="text-[#5e6278] text-sm sm:text-base leading-relaxed">
            ...
            <div id="research" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-8 space-y-4">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">Research & Innovation</h2>
                        <p class="text-[#5e6278] text-sm sm:text-base leading-relaxed">
            ...
            <div id="ethics" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-8 space-y-4">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">Ethical & Responsible AI</h2>
                        <p class="text-[#5e6278] text-sm sm:text-base leading-relaxed">
            ...
            <div id="industry" class="engitech-icon-box bg-white p-8 sm:p-12 border border-slate-100 shadow-xl scroll-mt-28">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-8 space-y-4">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-heading font-extrabold text-[#1b1d21]">Industry–Academia Partnership</h2>
                        <p class="text-[#5e6278] text-sm sm:text-base leading-relaxed">
