...
<section id="categories" class="py-20 lg:py-28 bg-[#0b0f19]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-14">
            <!-- Individual Member -->
            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between h-full">
                <div>
                    <h3 class="text-xl font-heading font-extrabold text-white mb-2">Individual Member</h3>
            ...
            <div class="engitech-icon-box p-8 bg-[#141a29] border-2 border-[#0c5adb] flex flex-col justify-between h-full shadow-2xl relative">
                <div class="absolute top-0 right-0 bg-gradient-to-r from-[#0c5adb] to-[#43baff] text-white px-3 py-1 text-[10px] font-heading font-extrabold uppercase rounded-bl-xl">
                    POPULAR
                </div>
                <div>
                    <h3 class="text-xl font-heading font-extrabold text-white mb-2">Institution Partner</h3>
                    <div class="text-3xl font-heading font-black text-white mb-2">Institutional</div>
            ...
            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between h-full">
                <div>
                    <h3 class="text-xl font-heading font-extrabold text-white mb-2">Industry Partner</h3>
                    <div class="text-3xl font-heading font-black text-white mb-2">Corporate</div>
            ...
            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between h-full">
                <div>
                    <h3 class="text-xl font-heading font-extrabold text-white mb-2">Student Chapter</h3>
                    <div class="text-3xl font-heading font-black text-white mb-2">Campus</div>
