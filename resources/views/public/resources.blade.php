...
<section class="py-20 lg:py-28 bg-[#0b0f19]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-slate-300 text-sm sm:text-base text-center max-w-2xl mx-auto mt-4 leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14">
            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between">
                <div>
                    <div class="text-4xl mb-4">📖</div>
                    <h3 class="text-lg font-heading font-bold text-white mb-2">Introduction to AI for Educators</h3>
                ...
                <span class="inline-block px-3 py-1 bg-blue-600/20 text-[#43baff] text-[11px] font-heading font-extrabold uppercase rounded-full border border-blue-500/30 w-max">Coming Soon</span>
            </div>

            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between">
                <div>
                    <div class="text-4xl mb-4">📖</div>
                    <h3 class="text-lg font-heading font-bold text-white mb-2">AI in the Classroom: Practical Guide</h3>
            ...
            <div class="engitech-icon-box p-8 bg-[#141a29] border border-slate-800 flex flex-col justify-between">
                <div>
                    <div class="text-4xl mb-4">📖</div>
                    <h3 class="text-lg font-heading font-bold text-white mb-2">AI Glossary for Education</h3>
